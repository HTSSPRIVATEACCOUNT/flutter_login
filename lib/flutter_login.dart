...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  ThemeData _mergeTheme(
    ...
    final errorColor = loginTheme.errorColor ?? theme.disabledColor;
    // the background is a dark gradient, force to use white text if detect default black text color
    final isDefaultBlackText = theme.textTheme.headlineLarge!.color ==
        Typography.blackMountainView.headlineLarge!.color;
    ...
    final textFieldStyle = theme.textTheme.labelSmall!
        .copyWith(color: blackOrWhite, fontSize: 14)
        .merge(loginTheme.textFieldStyle);
    final buttonStyle = theme.textTheme.displayLarge!
    ...
    return theme.copyWith(
      ...
      textTheme: theme.textTheme.copyWith(
        ...
        labelSmall: textFieldStyle,
        labelMedium: footerStyle,
        displayLarge: buttonStyle,
      ),
      colorScheme:
